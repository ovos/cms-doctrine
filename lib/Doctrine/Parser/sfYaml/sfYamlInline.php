...
class sfYamlInline
{
	...
	*/
	...
	switch (true)
	{
		...
		return "'$value'";
		case in_array(strtolower($value), $trueValues, true):
		return "'$value'";
		case in_array(strtolower($value), $falseValues, true):
		return "'$value'";
	...
	*/
	...
	{
	if (in_array($scalar[$i], $stringDelimiters, true))
	{
		// quoted scalar
	...
	*/
	...
	switch (true)
	{
		...
		case in_array(strtolower($scalar), $trueValues, true):
		return true;
		case in_array(strtolower($scalar), $falseValues, true):
		return false;
